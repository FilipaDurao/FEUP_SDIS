...
public class ResaveHandler extends SubscriptionHandler {
    ...
    public ResaveHandler(String fileId, Integer chunkNo, SubscriptionConnectionInterface subscriptionConnection, StoredInitiatorHandler subscriptionHandler, Peer peer) {
